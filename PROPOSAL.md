...
- [x] `scripts/clean.py`, `scripts/latency.py`, `scripts/m4_analysis.py`
...
4. **Finding.** Side-by-side histogram — 2020 window (6.7h) vs 2024 window (67.2h). Annotated with 10× ratio, p < 10⁻²⁰⁰, and survivorship-robust note. Inset shows election windows are faster than baseline overall.
